...
def setup():
    ...
    if not config.is_setup():
        ...
        if request.method == "POST":
            ...
            default_icon_location = url_for("views.themes", path="img/icon.png")

            # Splice in our banner
            index = f"""<div class="row justify-content-center align-items-center" style="min-height: calc(100vh - 180px);">
    <div class="col-lg-9 col-md-10">
        <div class="d-flex justify-content-center align-items-center" style="gap: 16px; margin: 0 auto 1rem auto;">
            <img style="display:block;width:min(76vw,620px);max-width:620px;height:auto;" src="{default_ctf_banner_location}" alt="{ctf_name} logo" />
            <img style="display:block;height:min(24.5vw,200px);max-height:200px;min-height:64px;width:auto;" src="{default_icon_location}" alt="Team icon" />
        </div>
        <div class="text-center mt-5">
            <a class="btn btn-primary m-1" style="font-size:1.06rem;padding:.62rem 1.55rem;" href="/login">Login</a>
            <a class="btn btn-outline-primary m-1" style="font-size:1.06rem;padding:.62rem 1.55rem;" href="/register">Register</a>
        </div>
        <h3 class="text-center mt-5 mb-2" style="font-size: 1.56rem; line-height: 1.35;">
            <p>We are a High School Cybersecurity team focused on practical offensive and defensive security training.</p>
            <p><strong>We release new CTF challenges every month.</strong></p>
        </h3>
    </div>
</div>"""
            page.content = index
